...
public class CryptoApiController {
    ...
    public CryptoApiDto getPrice(@RequestParam("coin") String coin){
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/hist_price")
    public CryptoApiDto getHistPrice(@RequestParam("coin") String coin, @RequestParam("time") @DateTimeFormat(pattern = "yyyy.MM.dd HH:mm:ss") LocalDateTime time){
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/full_data")
    public CryptoApiDto getFullData(@RequestParam("coin") String coin) {
        try{
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/list_full_data")
    public DataDto getListFullData(@RequestParam("coin") String coin, @RequestParam("limit") int limit){
